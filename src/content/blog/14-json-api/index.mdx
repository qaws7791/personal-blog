...
JSON:API는 2013년 5월 Yehuda Katz가 초안 작성을 시작으로 2015년 5월 안정된 1.0 버전이 출시되었습니다. MIME 유형은 `application/vnd.api+json`이며 공식 깃허브 주소는 <https://github.com/json-api>입니다. JSON:API는 JSON을 사용하는 API를 구축하기 위한 사양으로 다음과 같은 목적을 가지고 있습니다.
